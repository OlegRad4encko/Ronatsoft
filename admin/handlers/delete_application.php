...
$delete_application = $db->query("DELETE FROM `applications` WHERE SHA2(`id_application`, 256) = :id_application",[
    'id_application' => findXSS($_POST['application_id'])
]);
...
add_history([
    ...
    'action_type' => 6,
    'last_value' =>  array_encode_json($application_data[0]),
    'new_value' => NULL,
    'additional_info' => NULL
    ]);

echo build_success_block("Application successfully deleted");
