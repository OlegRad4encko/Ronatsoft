function add_new_block(link_id, icon, label, link, token) {
    ...
    block_string += '<input class="social_link" type="text" name="label" placeholder="Social name (alias)" value="'+ label +'" readonly required>';
    block_string += '<input class="social_link" type="text" name="icon" placeholder="icon class" value="'+ icon +'" readonly required>';
    block_string += '<input class="social_link" type="text" name="link" placeholder="social link" value="'+ link +'" readonly required>';
...
function save_changes() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.indexOf('success') != -1) {
                $('#soc_'+update_data['id_link']).find('.social_link').prop('readonly', true);
...
function edit_social() {
    ...
    $(this).siblings('input.social_link').prop('readonly', false);
...
$(document).ready(function () {
    ...
    // edit social link
    $('input.social_link').on('dblclick', edit_social);
